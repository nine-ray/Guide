...
| 5009     | 未知错误  | 
 ...
 | type      | 商品类型（虚拟商品、真实商品、食品）    | 否     | string   |        VIRTUAL, ACTUAL, CATER
 | published      | 是否上架    | 否      | bool   |默认true
 | deleted      | 是否删除    | 否      | bool   | 默认false
 | categoryId      | 二级工业分类ID    | 否     | number   |
...
| totalSales     | 销售总数  | number   |      |
 ...
 ### 4.1 商品详情查询
 > http://ipaddress:8050/product/detail
...
| deleted      | 是否删除 | bool |      |
| mainImageUrl     | 商品主图列表  | array   |  展示第一张    |
| categoryName     | 商品工业分类名称  | string   |      |
| detailImageUrl      | 详情图列表    | array   |
| skus      | sku列表    | array   |
